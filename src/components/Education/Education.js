...
const Education = () => {
  return (
    <section
      id="education"
      name="education"
      className="section h-screen w-full ml-6"
    >
      <div className="mx-auto max-w-screen-xl">
          ...
          <div className="flex flex-col">
            <div className="flex flex-col mb-10">
              <motion.div
                ...
                className="group relative overflow-hidden border-none rounded-md pl-20 pb-2 pr-2"
              >
                <div className="flex flex-row items-center mt-4">
                  <div className="flex items-start justify-center">
                    <a
                      href="https://nith.ac.in/"
                      className="flex h-28 w-28 items-center justify-center mx-2 rounded-full hover:glow"
                      style={{ "--glow-color": "silver" }}
                    >
                        ...
                        <div className="flex flex-col items-center bg-transparent border border-gray-200 rounded-lg md:flex-row md:max-w-full dark:border-gray-700 dark:bg-transparent">
                          <div className=" text-gray-900 dark:text-white">
                            ...
                            <div className="list-disc p-6 font-normal text-gray-700 dark:text-gray-400">
                              <li>
                                {" "}
                                I have studied core subjects like Data
                                Structures, DBMS, etc.
                              </li>
                              <li>
                                {" "}
        ...
        <motion.div
          ...
          whileInView={"show"}
          viewport={{ once: false, amount: 0.3 }}
          className="group relative overflow-hidden w-4/6 border-none rounded-sm pl-2 pb-2"
        >
          <div className="flex flex-row items-center mt-4">
            <div className="flex items-start justify-center">
              <div className="flex flex-row rounded-lg">
                    ...
                    <div className=" text-gray-900 dark:text-white">
                      <div className="bg-cyan-500 rounded-t-lg flex flex-col justify-between p-4 leading-normal">
                        <div className="flex justify-between">
                          ...
                          <span className="tracking-tighter">2017 - 2020</span>
                        </div>
                        <div className="text-base">10th and 12th</div>
                      </div>
